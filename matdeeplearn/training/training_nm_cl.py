...
def train_pretrain(model, model_linear, optimizer, optimizer_linear, loader_cl1, loader_cl2, loader_nm, criterion_nm, criterion_cl, rank):
    ...
    for data_cl1, data_cl2, data_nm in zip(loader_cl1, loader_cl2, loader_nm):
        ...
        loss_cl = criterion_cl(z_g1, z_g2)
        '''
...
def evaluate_pretrain(loader_cl1, loader_cl2, loader_nm, model, model_linear, criterion_nm, criterion_cl, rank, out=False):
...
def trainer(
    ...
    for epoch in range(1, epochs + 1):
        ...
        ## loader_cl1, loader_cl2, loader_nm, model, model_linear, criterion_nm, criterion_cl, rank, out=False
        #if rank not in ("cpu", "cuda"):
        ...
        #testtest_time = time.time()
        #print('UUUUUUUU: ', val_loader_cl1, val_loader_cl2, val_loader_nm)
        val_error, val_acc_atom = evaluate_pretrain(val_loader_cl1, val_loader_cl2, val_loader_nm, model.module, model_linear, loss_nm, loss_cl, rank=rank, out=False)
...
def train_regular(
    ...
    #print('5555555555555555555: ', train_cl1)
    ...
    model, num_epoch, num_train_error, num_val_error, num_train_acc_node, num_val_acc_node = trainer(
        rank,
        world_size,
        model,
        model_linear,
...
def train_regular_finetune(
    ...
    #train_dataset, val_dataset, test_dataset = process.split_data(dataset, training_parameters["train_ratio"], training_parameters["val_ratio"],training_parameters["test_ratio"], job_parameters["seed"])
